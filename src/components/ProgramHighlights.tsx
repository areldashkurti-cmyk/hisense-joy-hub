...
const highlights = [
  {
    ...
    body: "Earn on every qualified install, paid via a reloadable Mastercard®. Use your rewards your way — business expenses or personal.",
    bullets: [
  ...
  },
  {
    ...
    body: "Reinvest in growth. Accruals fund advertising, digital marketing, events, training, and other approved initiatives that drive local demand.",
    bullets: [
  ...
  },
  {
    ...
    body: "Install Hisense with peace of mind. Up to two years of included extended labor coverage on qualifying systems, with the option to purchase up to ten years.",
    bullets: [
